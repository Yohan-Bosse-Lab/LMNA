...
###
bag3$xlab = c(1,2,1,2) 
bag3$ylab = c(1.02,1.02,5/34+0.03,5/15+0.03)
bag3$labels = c('29','10','5','5')
...
bag3_ggplot =
  ggplot(bag3) + 
    ...
    geom_text(aes(label = labels, x = xlab, y = ylab)) +
    scale_fill_brewer(palette="Paired") +
    ggtitle('BAG3 genotypes ~ severity\n(Odds-ratio of G allele = 2.82, p-value = 0.25)') +
    ylab('Frequency') +
    xlab('') +
    theme_bw()

#save plot
pdf(file.path(params$resultspath,paste0('May2025/Figure10_bag3.pdf')),width = 5,height = 5)
bag3_ggplot
dev.off()
```
...
bag3$ylab = c(1.02,1.02,1.02,5/34+0.03,4/12+0.03,1/3+0.03)
bag3$labels = c(29,8,4,5,4,1)
...
bag3_ggplot =
  ggplot(bag3) + 
    ...
    geom_text(aes(label = labels, x = xlab, y = ylab)) +
    scale_fill_brewer(palette="Paired") +
    ggtitle('BAG3 genotypes ~ severity\n(Odds-ratio of G allele = 2.82, p-value = 0.24)') +
    ylab('Frequency') +
    xlab('') +
    theme_bw()

#save plot
pdf(file.path(params$resultspath,paste0('May2025/Figure10_bag3_v2.pdf')),width = 5,height = 5)
bag3_ggplot
dev.off()
```
