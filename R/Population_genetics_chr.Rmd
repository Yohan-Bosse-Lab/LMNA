...
write.table(colnames_family,file.path(params$datapath,'clinical/severe.txt'),row.names = F, quote = T,sep = '\t')
...
n_samples = 52
  ...
  #chr_medium = merge(chr_medium, colnames_family,by.x = 'sampleID',by.y = 'dossier')
