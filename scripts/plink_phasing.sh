...
#mkdir LMNA_148_samples
#cp /home/renseb01/Documents/mendel_Christian_Steinberg/YB-P01_LORD_only_Plus_Steinberg_LMNA_148_samples/PLINK_200225_0230/* LMNA_148_samples/.
...
####THE REST (below) is DONE via an Rscript locally


#####CLEANUP THE PHASED .vcf
mkdir LMNA_52_phased
...
########HAPLOBLOCKS
#make bed file
/home/renseb01/plink2 --vcf chr1_h12.vcf --make-bed --out chr1

#find haplo blocks
plink --blocks-strong-lowci 0.6 --blocks-strong-highci 0.84 --blocks-recomb-highci 0.8 --bfile chr1 --blo
cks no-pheno-req --out chr1_haploblocks
